...
Provide prioritized work queue infrastructure for coordinating OpenSpec implementation across manual sessions. The system manages approved specs, calculates priorities based on classification and age, handles dependency blocking, and tracks session assignments.
